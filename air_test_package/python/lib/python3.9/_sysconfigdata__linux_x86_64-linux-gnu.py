...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--with-openssl=/usr/local/src/openssl-1.1.1w' "
                "'--prefix=/tmp/python'",
 'CONFINCLUDEDIR': '/tmp/python/include',
 'CONFINCLUDEPY': '/tmp/python/include/python3.9',
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/usr/local/src/Python-3.9.14/coverage.info',
 'COVERAGE_REPORT': '/usr/local/src/Python-3.9.14/lcov-report',
 ...
 'OBJECT_OBJS': '\\',
 'OPENSSL_INCLUDES': '-I/usr/local/src/openssl-1.1.1w/include',
 'OPENSSL_LDFLAGS': '-L/usr/local/src/openssl-1.1.1w/lib',
 ...
 'abs_builddir': '/usr/local/src/Python-3.9.14',
 'abs_srcdir': '/usr/local/src/Python-3.9.14',
